...
use Closure;
use Xooxx\Serializer\Serializer\InternalClasses\SplFixedArraySerializer;
use Xooxx\Serializer\Strategy\StrategyInterface;
use ReflectionClass;
...
class Serializer
{
    ...
    /**
     * @var \Xooxx\Serializer\Strategy\StrategyInterface|\Xooxx\Serializer\Strategy\JsonStrategy
     */
     ...
     * @var array
     */
    protected $serializationMap = ['array' => 'serializeArray', 'integer' => 'serializeScalar', 'double' => 'serializeScalar', 'boolean' => 'serializeScalar', 'string' => 'serializeScalar'];
    /**
    ...
    protected function guardForUnsupportedValues($value)
    {
        ...
        if ($value instanceof \DatePeriod) {
            throw new SerializerException('DatePeriod is not supported in Serializer. Loop through it and serialize the output.');
        }
    ...
    protected function serializeScalar($value)
    {
        ...
        return [self::SCALAR_TYPE => $type, self::SCALAR_VALUE => $value];
    }
