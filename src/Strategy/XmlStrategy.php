...
class XmlStrategy implements StrategyInterface
{
     ...
     * @var array
     */
    private $replacements = [Serializer::CLASS_IDENTIFIER_KEY => 'np_serializer_type', Serializer::SCALAR_TYPE => 'np_serializer_scalar', Serializer::SCALAR_VALUE => 'np_serializer_value', Serializer::MAP_TYPE => 'np_serializer_map'];
    /**
     * @param mixed $value
     *
     * @return string
